...
template<> OCULUSXRMOVEMENT_API UScriptStruct* StaticStruct<FOculusXRAnimCurveMapping>()
{
	...
	struct Z_CompiledInDeferFile_FID_Users_nick_Documents_GitHub_VRArenaTemplate_VRArenaTemplate_Plugins_MetaXR_Source_OculusXRMovement_Public_OculusXRLiveLinkRetargetFaceAsset_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_nick_Documents_GitHub_VRArenaTemplate_VRArenaTemplate_Plugins_MetaXR_Source_OculusXRMovement_Public_OculusXRLiveLinkRetargetFaceAsset_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_nick_Documents_GitHub_VRArenaTemplate_VRArenaTemplate_Plugins_MetaXR_Source_OculusXRMovement_Public_OculusXRLiveLinkRetargetFaceAsset_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_nick_Documents_GitHub_VRArenaTemplate_VRArenaTemplate_Plugins_MetaXR_Source_OculusXRMovement_Public_OculusXRLiveLinkRetargetFaceAsset_h_3020331922(TEXT("/Script/OculusXRMovement"),
		Z_CompiledInDeferFile_FID_Users_nick_Documents_GitHub_VRArenaTemplate_VRArenaTemplate_Plugins_MetaXR_Source_OculusXRMovement_Public_OculusXRLiveLinkRetargetFaceAsset_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_nick_Documents_GitHub_VRArenaTemplate_VRArenaTemplate_Plugins_MetaXR_Source_OculusXRMovement_Public_OculusXRLiveLinkRetargetFaceAsset_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Users_nick_Documents_GitHub_VRArenaTemplate_VRArenaTemplate_Plugins_MetaXR_Source_OculusXRMovement_Public_OculusXRLiveLinkRetargetFaceAsset_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_nick_Documents_GitHub_VRArenaTemplate_VRArenaTemplate_Plugins_MetaXR_Source_OculusXRMovement_Public_OculusXRLiveLinkRetargetFaceAsset_h_Statics::ScriptStructInfo),
		nullptr, 0);
